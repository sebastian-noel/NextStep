  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <header className="relative w-full flex flex-col items-center pt-12 pb-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Safety Awareness</h4>
              <div className="text-sm text-gray-500 mb-2">25 points</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Insurance Knowledge</h4>
              <div className="text-sm text-gray-500 mb-2">25 points</div>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Procedural Understanding</h4>
              <div className="text-sm text-gray-500 mb-2">25 points</div>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <h4 className="text-lg font-bold text-gray-800 mb-2">Decision-Making Quality</h4>
              <div className="text-sm text-gray-500 mb-2">25 points</div>
              <p className="text-gray-600 text-sm leading-relaxed">
